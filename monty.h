...
void pushNode(stack_t **head, unsigned int number);
void printEVerything(stack_t **head, unsigned int number);
void printStackHead(stack_t **head, unsigned int number);
int execute_instructions(char *content, stack_t **head, unsigned int counter, FILE *file);
...
void printChar_sring(stack_t **head, unsigned int counter);
void printStr_top(stack_t **head, unsigned int counter);
void rotate_left(stack_t **head, unsigned int counter);
